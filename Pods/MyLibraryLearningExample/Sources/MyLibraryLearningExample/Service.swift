...
public struct Service {
    ...
    func download(path: String, completion: @escaping (Data, Bool) ->()) {
        ...
        let fullUrl = "https://apidrive.ulima.edu.pe/drive/webapi/entry.cgi?api=SYNO.FileStation.Download&version=2&method=download&path=\(path)&mode=%22open%22"
